...
public class UserController {
    ...
    public ResponseEntity<UserResponse.UserPoint> getUserPoint (@PathVariable Long userId) {
        return ResponseEntity.status(HttpStatus.OK).body(UserResponse.UserPoint.from(userFacade.getPointResult(userId)));
    }
}
