...
import org.hhplus.ticketing.interfaces.controller.queue.QueueController;
...
public class QueueControllerTest {
    ...
    void getQueueStatusTest_대기열_확인_컨트롤러_테스트_예상_리턴_데이터_확인 () throws Exception {
        // Given
        QueueResult.QueueStatusResult result = new QueueResult.QueueStatusResult(userId, token, 0L);
